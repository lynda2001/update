                        ...
                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                ...
                                {examDatas.map((exam, index) => (
                                    ...
                                    >
                                        <TableCell component="th" scope="exam" style={{ color: "#222831", fontSize: "16px", fontWeight: "600", padding: "25px" }}>
                                            ...
                                            <br />
                                            <Button sx={{color:"white", backgroundColor:"black", "&:hover": {color:"black", backgroundColor:"white"}, mt:4}} onClick={() => deleteQuestion(exam._id)}>Delete</Button>
                                        </TableCell>
                                        <TableCell align="right"></TableCell>
                                        <TableCell align="right"></TableCell>
                                        <TableCell align="right"></TableCell>
                            ...
                            <TableHead>
                                <TableRow>
                                    ...
                                    >
                                        {close => (
                                            <div style={{ fontSize: "12px", backgroundColor: "#111212", width: "800px", height: "auto" }}>
                                    ...
                                    <TableCell></TableCell>
                                    <TableCell></TableCell>
                                    <TableCell align='right'><Link to={`/updatest/${examId}/${userId}`}><NextButton>Next<ArrowForward style={{ verticalAlign: "middle", transform: "scale(0.9)" }} /></NextButton></Link></TableCell>
                                </TableRow>
                            </TableHead>
                        </Table>
                    </TableContainer>
