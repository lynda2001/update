...
export default function CompanyFooter() {
  ...
  return (
    <Box sx={{ backgroundColor: "#f5f5f5", py: 4,  }}>
      <Container maxWidth="lg" sx={{postion:"fixed", bottom:"1rem"}}>
        <Grid container spacing={4}>
          <Grid item xs={12} sm={6} md={3}>
            ...
            <Typography  variant="body1" sx={{ mb: 1, fontFamily: "Oswald", color: "#666", fontSize: 16, "&:hover": {color:"black"}  }}>
             <a href="/" style={{textDecoration:"none", fontFamily: "Oswald", color: "#666", fontSize: 16, "&:hover": {color:"black"}}}> Dashboard </a>
            </Typography>
            <Typography variant="body1" sx={{ mb: 1, fontFamily: "Oswald", color: "#666", fontSize: 16, "&:hover": {color:"black"} }}>
            Maintenance
            </Typography>
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            <Typography variant="body1" sx={{ mb: 1, fontFamily: "Oswald", color: "#666", fontSize: 16, "&:hover": {color:"black"} }}>
            <a href="/" style={{textDecoration:"none", fontFamily: "Oswald", color: "#666", fontSize: 16, "&:hover": {color:"black"}}}> Contact Royecruit</a>
            </Typography>
            <Typography variant="body1" sx={{ mb: 1, fontFamily: "Oswald", color: "#666", fontSize: 16, "&:hover": {color:"black"} }}>
            <a href="/" style={{textDecoration:"none", fontFamily: "Oswald", color: "#666", fontSize: 16, "&:hover": {color:"black"}}}> Incoming Mails</a>
            </Typography>
          </Grid>
          <Grid item xs={12} sm={6} md={3}>
            <Typography variant="h5" sx={{ mb: 2, fontFamily: "Oswald", fontSize: 18, fontWeight: "bolder" }}>
