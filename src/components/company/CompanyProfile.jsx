...
function CompanyProfile() {
  ...
  useEffect(() => {
    const token = localStorage.getItem('companydatatoken');
    if (token) {
    ...
    function calculateAge (){
        ...
        const handleCompanyserviceChange = (event) => {
        ...
        const handleSubmit = async (event) => {
            ...
            try {
              const response = await fetch(`http://localhost:5000/royecruit/updatecompanyinfo/${userId}`, {
                method: 'PUT',
                headers: {
          ...
          const handleDone = async (event) => {
            ...
            try {
              const response = await fetch(`http://localhost:5000/royecruit/updatecompany/${userId}`, {
                method: 'PUT',
                headers: {
                  'Content-Type': 'application/json',
                },
          ...
          const handlePassword = async (event) => {
            ...
            try {
              const response = await fetch(`http://localhost:5000/royecruit/updatepasswordC/${userId}`, {
                method: 'PUT',
                headers: {
                  'Content-Type': 'application/json',
                },
          ...
          const handleImageUpdate = async () => {
            ...
            try {
              ...
              await axios.put(`http://localhost:5000/royecruit/company/${userId}/image`, formData);
      ...
      />
        ...
        <div>
            <Grid container spacing={0}>
                ...
                <Grid item xs={6}>
                <Typography sx={{fontFamily:"Oswald", fontSize:20, fontWeight:"bold", mt: 1, }}>Company Name<span style={{color:"red"}}>*</span></Typography>
                <Typography sx={{fontFamily:"Oswald", fontSize:22, fontWeight:300,}}>{user.companyname}</Typography>
                ...
                <Typography sx={{fontFamily:"Oswald", fontSize:20, fontWeight:"bold", mt: 3, }}>Number Of Employees<span style={{color:"red"}}>*</span></Typography>
                <Typography sx={{fontFamily:"Oswald", fontSize:22, fontWeight:300,}}>{user.companysize}</Typography>
                <Typography sx={{fontFamily:"Oswald", fontSize:20, fontWeight:"bold", mt: 3, }}>Website<span style={{color:"red"}}>*</span></Typography>
                <a href={user.companywebsite} target="_blank" rel="noopener noreferrer">
                <Typography sx={{ fontFamily: "Oswald", fontSize: 22, fontWeight: 300 }}>
                {user.companywebsite}
                </Typography>
                </a>
                ...
                <Grid item xs={6}>
                <Typography sx={{fontFamily:"Oswald", fontSize:20, fontWeight:"bold", mt: 1}}>Country<span style={{color:"red"}}>*</span></Typography>
                <Typography sx={{fontFamily:"Oswald", fontSize:22, fontWeight:300, }}>{user.companyaddress}</Typography>
                <Typography > {""} </Typography>
                <Typography > {""} </Typography>
                <Typography sx={{fontFamily:"Oswald", fontSize:20, fontWeight:"bold", mt: 14, }}>Line Of Work<span style={{color:"red"}}>*</span></Typography>
                <Typography sx={{fontFamily:"Oswald", fontSize:22, fontWeight:300,}}>{user.industry}</Typography>
  ...
  {activeTab === 'account' && (
   ...
   >
    ...
    <form onSubmit={handleDone}>
      ...
      <Typography sx={{fontFamily:"Oswald", fontSize:20, fontWeight:"bold", mt: 3, marginLeft: 32}}>Company Name & Country <span style={{color:"red"}}>*</span></Typography>
      <TextField type="text" label="Company Name" name="firstname" value={companyname} onChange={handleCompanynameChange} sx={{marginTop: 1 , width: '29.5%', marginLeft: 32}}   />
      <FormControl sx={{marginTop: 1, width: '30%', marginLeft: 7}}>
      ...
      <Typography sx={{fontFamily:"Oswald", fontSize:20, fontWeight:"bold", mt: 3, marginLeft: 32}}>Number Of Employees <span style={{color:"red"}}>*</span></Typography>
      <TextField type="text" label="Number Of Employees"  name="dateofbirth" value={companysize} onChange={handleCompanysizeChange} sx={{marginTop: 1 , width: '64%', marginLeft: 32}}   />

      <Typography sx={{fontFamily:"Oswald", fontSize:20, fontWeight:"bold", mt: 3, marginLeft: 32}}>Company Website <span style={{color:"red"}}>*</span></Typography>
      <TextField type="tel" label="Company Website" name="phone" value={companywebsite} onChange={handleCompanywebsiteChange} sx={{marginTop: 1 , width: '64%', marginLeft: 32}}   />

      <Typography sx={{fontFamily:"Oswald", fontSize:20, fontWeight:"bold", mt: 3, marginLeft: 32}}>Company Service <span style={{color:"red"}}>*</span></Typography>
      <TextField type="tel" label="Company Website" name="phone" value={companyservice} onChange={handleCompanyserviceChange} sx={{marginTop: 1 , width: '64%', marginLeft: 32}}   />
    
      <Typography sx={{fontFamily:"Oswald", fontSize:20, fontWeight:"bold", mt: 3, marginLeft: 32}}>Company Industry <span style={{color:"red"}}>*</span></Typography>
      ...
      <Typography sx={{mt:12}}></Typography>
      <Snackbar
        open={isSnackbarOpen}
        autoHideDuration={5000}
        onClose={handleCloseSnackbar}
