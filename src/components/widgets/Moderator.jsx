...
function Moderator() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (fullname ==='') {
      ...
      toast.error('Your name & lastname cannot include numbers', {
        position: 'bottom-center',
      });
    } else if ( email==='' ) {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:5000/royecruit/moderator', {
            fullname,
            email,
            problem,
          });
    ...
    <React.Fragment>
      ...
      <Grid item xs={12} sm={6}>
        ...
        transition: "transform 1s ease-in-out", }} elevation={0}>
          ...
          "There is no passion to be found playing<br/> small - in settling for a life that is less<br/> than the one you are capable of living."
          </Typography>
